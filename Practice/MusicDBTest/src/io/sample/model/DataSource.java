...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\yi" + ".zhou\\Workspace\\Github\\SQLite3\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_START = "SELECT " + TABLE_ALBUMS + '.' + COLUMN_ALBUM_NAME + " FROM " + TABLE_ALBUMS + " INNER JOIN " + TABLE_ARTISTS +
                                                              " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID + " WHERE " +
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START = "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + ", " +
                                                             ...
                                                             TABLE_SONGS + "." + COLUMN_SONG_ALBUM + " = " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ID + " INNER JOIN " + TABLE_ARTISTS +
                                                             " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID + " WHERE " +
                                                             TABLE_SONGS + "." + COLUMN_SONG_TITLE + " = \"Go Your Own Way\" ORDER BY " + TABLE_ARTISTS + "." +
                                                             COLUMN_ARTIST_NAME + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " COLLATE NOCASE ASC";
